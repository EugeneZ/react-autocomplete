...
module.exports = React.createClass({
  ...
  propTypes: {
    ...
    */
    ...
    /**
     * Passed untouched to the input if present
     */
  ...
  makeMenu: function(children) {
    ...
    children = React.Children.map(children, function(child, index) {
      ...
      if (this.state.value === child.props.value) {
        ...
        menuProps.id = child.props.id || 'rf-combobox-selected-'+(++guid);
        menuProps.isSelected = true
        activedescendant = child.props.id;
      }
      menuProps.onBlur = this.handleOptionBlur;
      menuProps.onClick = this.selectOption.bind(this, child);
      menuProps.onFocus = this.handleOptionFocus;
      menuProps.onKeyDown = this.handleOptionKeyDown.bind(this, child);
      menuProps.onMouseEnter = this.handleOptionMouseEnter.bind(this, index);
      
      return React.addons.cloneWithProps(child, menuProps);
    }.bind(this));
    return {
      children: children,
